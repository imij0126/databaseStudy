...
/*
    * 트리거 생성
    ...
    CREATE [OR REPLACE] TRIGGER 트리거 이름             -- 트리거 기본정보(이름)
...
INSERT INTO EMPLOYEE (EMP_ID,EMP_NAME,EMP_NO,DEPT_CODE,JOB_CODE,HIRE_DATE)
    VALUES(501,'김인창','95012-1000000','D6','J5',SYSDATE);
------------------------------------------------------------------------
-- 상품 입고 및 출고 관련
...
INSERT INTO TB_PRODUCT VALUES (SEQ_PNO.NEXTVAL, '갤럭시 폴드6', '삼성',2000000, 50);
INSERT INTO TB_PRODUCT VALUES (SEQ_PNO.NEXTVAL, '샤오미폰','샤오미',80000,500);
...
CREATE TABLE TB_PDETAIL(
    ...
    PNO NUMBER REFERENCES TB_PRODUCT, -- 기본키는 생략 가능해서 -- 상품번호
